// Creating all of the routes for user related processes
...
// Attackes the decoded user to req.user so protected controllers can identify whos making the request
